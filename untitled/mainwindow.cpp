...
QString file_name=QFileDialog::getOpenFileName(this,"open the XML file","Home",filter);
...
{
    //QString filter="XML File (*.xml)";
QString file_name=QFileDialog::getSaveFileName(this,"open the XML file","Home");
QFile file(file_name);
file_path=file_name;
...
{
     QString filter="XML File (*.xml)";
    QString Path = QFileDialog::getOpenFileName(this, tr("Open XML File to compress"),"Home",filter);
